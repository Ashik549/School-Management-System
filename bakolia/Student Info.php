...
<?php
    ...
    global $fetch;
    $result=mysql_query("select * from student") or die("error");
    echo '<table style="width:80%;">';
    echo '<th align="left">NAMES</th><th align="left">ADDRESS</th><th align="left" >ID</th><th align="left">CLASS</th><th align="left">EDIT</th><th align="left" colspan=2>DELETE</th>';
    if($result)
    {
        while ($fetch= mysql_fetch_assoc($result))
        {
               ...
               . '<td><a href=deletet.php?id='.$fetch['ID'].'>'
