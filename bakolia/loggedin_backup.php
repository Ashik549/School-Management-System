...
<div class="header">
  ...
  <p>Education for Humanaization</p>
...
<ul>
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="#">New Student Entry</a>
        <a href="#">Erase Records</a>
        <a href="#news">Fees Query</a></div><li>
  <li class="dropdown">
    <a href="javascript:void(0)" class="dropbtn">Teachers</a>
    <div class="dropdown-content">
      <a href="#">Informations</a>
      <a href="#">New Teacher Entry</a>
        <a href="#">Erase Records</a>
  <a href="#">Salary Query</a> 
<li class="dropdown">
